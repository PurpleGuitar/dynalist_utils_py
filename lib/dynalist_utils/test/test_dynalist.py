...
class TestGetIndexByNodeId(unittest.TestCase):
    ...
    def test_simple_doc(self):
        ...
        data = dynalist.load_json_from_file(
            os.path.join(TEST_DIR, "test_dynalist_colors.json"))
...
class TestDocument(unittest.TestCase):
    ...
    def test_from_json_stream(self):
        """ Test a simple document """
        with open(os.path.join(TEST_DIR, "test_dynalist_colors.json")) as stream:
    ...
    def test_to_json(self):
        """ Test a simple document """
        filename = os.path.join(TEST_DIR, "test_dynalist_colors.json")
    ...
    def test_get_nodes_api_order(self):
        ...
        doc = dynalist.Document.from_json_file(
            os.path.join(TEST_DIR, "test_dynalist_colors_reversed.json"))
    ...
    def test_get_metadata(self):
        ...
        doc = dynalist.Document.from_json_file(
            os.path.join(TEST_DIR, "test_dynalist_collapsed.json"))
